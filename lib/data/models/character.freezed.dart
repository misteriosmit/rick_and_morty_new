...
class _$InfoTearOff {
  ...
  _Info call(
      {required int count, required int pages, String? next, String? prew}) {
    return _Info(
      count: count,
      pages: pages,
      next: next,
...
mixin _$Info {
  ...
  String? get prew => throw _privateConstructorUsedError;
...
abstract class $InfoCopyWith<$Res> {
  ...
  $Res call({int count, int pages, String? next, String? prew});
}
...
class _$InfoCopyWithImpl<$Res> implements $InfoCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      prew: prew == freezed
          ? _value.prew
          : prew // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
}
...
class _$_Info with DiagnosticableTreeMixin implements _Info {
  const _$_Info(
      {required this.count, required this.pages, this.next, this.prew});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Info(count: $count, pages: $pages, next: $next, prew: $prew)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('prew', prew));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.prew, prew));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(prew));
