...
import 'package:rick_and_morty_new/bloc/character_bloc.dart';
import 'package:rick_and_morty_new/ui/widgets/custom_list_tile.dart';
...
class _SearchPageState extends State<SearchPage> {
  late Character
      _currentCharacter; // Информация об общем колличестве страниц и персонажей
  List<Results> _currentResults = []; // Массив персонажей
  int _currentPage =
      1; // для отслеживания текущей страницы и пагинации(подзагрузки персонажей)
  String _currentSearchStr =
      ''; // текущая строка в поиске которую ввсел пользователь
      ...
      children: [
        ...
        Expanded(
          child: state.when(
            ...
            loaded: (cheracterLoaded) {
              _currentCharacter = cheracterLoaded;
              if (_isPagination) {
